const ibaiImg = "/images/ibai.png_1754677747540.webp";
const elxocasImg = "/images/elxocas.jpg_1754677747540.webp";
const illojImg = "/images/illojuan.jpg_1754677747540.webp";
const grefgImg = "/images/thegrefg_1754677747540.avif";
const coscuImg = "/images/coscu_1754677747540.jpg";

// Affiliate link helper function
const amazonSearchUrl = (query: string) => {
  return `https://www.amazon.es/s?k=${encodeURIComponent(query)}&tag=yostreamer-21`;
};
    ...
    setup: [
      {
        name: "Audio",
        items: [
          { name: "Shure SM7B", description: "Micrófono dinámico icónico para voz", affiliateLink: amazonSearchUrl("Shure SM7B") },
          { name: "Soporte de brazo", description: "Ajuste preciso y estable", affiliateLink: amazonSearchUrl("brazo micrófono broadcast") },
          { name: "Interfaz GoXLR / Focusrite", description: "Control de mezcla y ganancia", affiliateLink: amazonSearchUrl("GoXLR Focusrite Scarlett") },
        ],
      },
      {
        name: "Cámara",
